...
global.OrionSession = SC.Object.extend({
   ...
   sessionCookieExpireDuration: 1, // duration in days
   
   timeOutDuration: 1, //(timeout in minutes) 15 minutes standard 
   ...
   */
   ...
   checkSession: function(user,sessionInfo,sessionKeyOnly){
      ...
      if(!sessionKeyOnly){
        ...
        receivedSessionKey = sessionInfo.replace(/OrionServer=/gi,"");
